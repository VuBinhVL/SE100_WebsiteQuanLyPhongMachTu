          ...
          <ul className="nav nav-pills flex-column">
            ...
            <li className="nav-item text-black fs-5 py-2 py-sm-0">
              <NavLink
                ...
                aria-current="page"
              >
                <GiMedicinePills className="fs-4 icon-medicine icon " />
                <span className="ms-3">Medicine Group</span>
              </NavLink>
            </li>
            ...
            <li className="nav-item text-black fs-5 py-2 py-sm-0">
              <NavLink
                ...
                aria-current="page"
              >
                <FaShieldVirus className="fs-4 icon-medicine icon " />
                <span className="ms-3">Disease Group</span>
              </NavLink>
            </li>
            ...
            <li className="nav-item text-black fs-5 py-2 py-sm-0">
              <NavLink
                ...
                aria-current="page"
              >
                <IoSettings className="fs-4 icon-medicine icon " />
                <span className="ms-3">Parameter</span>
              </NavLink>
            </li>
          </ul>
        </div>
