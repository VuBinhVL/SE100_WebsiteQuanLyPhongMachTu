...
export default function DetailShift(props) {
    ...
    const handleCancel = () => {
        ...
        const { chuyenMon, chuyenMonId, hoSoBenhAns, isLock
            ...
            , tenTaiKhoan
            , vaiTro, vaiTroId
            , ...newInformation } = informationShift;
        setDataForm(newInformation);
    ...
    return (
        <>
            ...
            <div className="detailShift modal fade" id={idModal} data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        ...
                        <div className="modal-body d-flex justify-content-center">
                            <form className="me-5 w-75">
                                <div className="form-group mb-3 d-flex align-items-center">
                                    ...
                                    <input className="form-control rounded-3" name="tenCaKham" id="tenCaKham" type="text" placeholder="Enter full name" value={dataForm.hoTen} onChange={handleChange} readOnly={!editStatus} />
                                </div>
                                <div className="form-group mb-3 d-flex align-items-center position-relative">
                                    ...
                                    {editStatus ? (
                                        ...
                                        <input type="text" id="khungGio" name="khungGio" className="form-control rounded-3" value={dataForm.gioiTinh} readOnly />
                                    )}
                                ...
                                <div className="form-group mb-3 d-flex align-items-center">
                                    ...
                                    {
                                        editStatus ? (
                                            <input type="date" id="ngayKham" name="ngayKham" className="form-control rounded-3" defaultValue={formatDate(dataForm.ngaySinh)} onChange={handleChange} readOnly={!editStatus} />
                                        ) : (
                                            <input type="date" id="ngayKham" name="ngayKham" className="form-control rounded-3" value={formatDate(dataForm.ngaySinh)} onChange={handleChange} readOnly={!editStatus} />
                                        )
                                    }
                                </div>
                                <div className="form-group mb-3 d-flex align-items-center position-relative">
                                    ...
                                    {editStatus ? (
                                        <select id="tenNhomBenh" name="tenNhomBenh" className="form-control rounded-3" value={dataForm.chuyenMonId} onChange={handleChange}>
                                        ...
                                        <input type="text" id="tenNhomBenh" name="tenNhomBenh" className="form-control rounded-3" value={specialization.find(spec => spec.id == dataForm.tenNhomBenh)?.tenNhomBenh || "ABC"
                                        } readOnly={!editStatus} />
                                    )}
                                    <IoIosArrowDown className="position-absolute end-0 me-3" />
                                </div>
                                <div className="form-group mb-3 d-flex align-items-center">
                                    ...
                                    <input name="soLuongBenhNhanToiDa" id="soLuongBenhNhanToiDa" type="text" className="form-control rounded-3" placeholder="Enter your Email" value={dataForm.email} onChange={handleChange} readOnly={!editStatus} />
                                </div>
                                <div className="form-group mb-3 d-flex align-items-center">
                                    <label htmlFor="bacSiId" className="form-label col-4 custom-bold">Doctor:</label>
                                    <input name="bacSiId" id="bacSiId" type="text" className="form-control rounded-3" placeholder="Enter your address" value={dataForm.diaChi} onChange={handleChange} readOnly={!editStatus} />
                                </div>
                            </form>
                        </div>
                        {editStatus ? (
