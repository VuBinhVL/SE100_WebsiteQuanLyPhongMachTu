...
export default function AddShift(props) {
    ...
    const handleSubmit = (event) => {
        ...
        const { tenCaKham, khungGio, ngayKham, soLuongBenhNhanToiDa, nhomBenhId } = dataForm;

        // Validate dữ liệu trước khi gửi
        if (!tenCaKham || !khungGio || !ngayKham || !soLuongBenhNhanToiDa || !nhomBenhId) {
        ...
        if (ngayKhamDate < currentDate) {
            showErrorMessageBox("The exploration date must start from tomorrow onwards");
            return;
        }

        if (ngayKhamDate > maxDate) {
            showErrorMessageBox("The exploration date must be within 30 days from tomorrow");
            return;
        }
    ...
    return (
        <>
            ...
            <button type="button" className="Add_Shift col-2 rounded-2 d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body d-flex justify-content-center">
                            <form className="me-5 w-75">
                                ...
                                <div className="form-group mb-3 d-flex align-items-center position-relative">
                                    <label htmlFor="nhomBenhId" className="form-label col-4 custom-bold">Disease Group:</label>
                                    <select id="nhomBenhId" name="nhomBenhId" className="form-control rounded-3" onChange={handleChange} defaultValue="DEFAULT">
